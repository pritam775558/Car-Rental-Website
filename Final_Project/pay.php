	...
	<section class="listings">
		<div class="wrapper">
			<ul class="properties_list">
				...
				<h5>DSA Verification Code: Transaction ID</h5>
				<h6>National ID: Comapany ID Number Registered with</h6>
				<form method="post">
					<table>
						<tr>
							<td>DSA Transaction ID:</td>
						...
						if(isset($_POST['pay'])){
							...
							if($result == TRUE){
								echo "<script type = \"text/javascript\">
											alert(\"Payment Successfully Done. Wait for Company Approval\");
			...
			<div class="more_listing">
				<a href="rentals.php" class="more_listing_btn">View More Listings</a>
			</div>
		</div>
	</section>	
